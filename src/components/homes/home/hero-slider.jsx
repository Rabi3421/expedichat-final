...
import banner from "../../../../public/assets/img/hero/banner.png";
  ...
  hero_title: (
    <>
      <span className="tp_title">
        <span className="child">Optimize your work with</span>
      </span>{" "}
      <br />
      <span>
        <span className="child">leading AI solutions</span>
      </span>{" "}
    </>
  ),
  sub_title: <>Request a free demo today and unlock its hidden efficiencies.</>,
  hero_shape_img: [
    {
      id: 1,
      cls: "1",
