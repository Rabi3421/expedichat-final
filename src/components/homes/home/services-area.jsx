...
import service_data, { paid_tools_data } from '@/data/service-data';
...
const service_content = {
    title: "Achieve goals with best productivity tools",
    sub_title: <>Embrace innovation and stay ahead in your field with the best-in-class tools tailored to boost your performance</>,

    bg_img: "/assets/img/service/sv-bg.jpg",
    title_2: <>Explore More<br /> Paid & Free Tools</>,
    des: <>Find the best tools, both free and premium, to boost your productivity and creativity.</>,
            ...
            <div className="tp-service__area p-relative fix">
               ...
               <div className="container">
                  ...
                  <div className="row">
                    ...
                    {paid_tools_data.slice(0,5).map((item, i)  => 
                     ...
                     <div className="col-xl-4 col-lg-4 col-md-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay="1s">
                        ...
                        style={{backgroundImage: `url(${bg_img})`}} >
                           <div className="tp-service__top-content">
                              ...
                              <p>{des}</p>
                              <Link className="tp-btn-orange tp-btn-hover alt-color-white" href="/ai-tools">
                                 <span>{btn_text}</span>
                                 <b></b>
                              </Link>
                           </div>
