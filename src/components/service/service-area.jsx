...
const service_content = {
    title: <>Advanced AI <br /> for Accurate Responses</>,
    btn_text: <>Find out more</>,
 
    bg_img: "/assets/img/service/service-3-bg.png",
    service_title: "Ask anything, anytime, anywhere!",
    service_info: <>Experience the next level of communication with the best AI chat system that understands and responds to your needs.</>,
 }
            ...
            <div className="tp-service-area pb-120 z-index">
               <div className="container">
                        ...
                        <div className="tp-service-section-wrapper mb-60 d-flex justify-content-between align-items-end">
                           <h3 className="tp-section-title tp-title-anim">{title}</h3>
                              <Link className="tp-btn-inner tp-btn-hover alt-color-black wow tpfadeRight" 
                                 ...
                                 data-wow-delay=".3s" 
                                 href="https://dashboard.expedicaht.com">
                                 <span>{btn_text}</span>
                                 <b></b>
                              </Link>
                        </div>
                  ...
                  <div className="row">
                        ...
                        <div className="tp-service-3-item mb-30 p-relative z-index" style={{backgroundImage: `url(${bg_img})`}}>
                           ...
                           <div className="tp-service-3-content">
                              ...
                              <h4 className="tp-service-3-title-sm">
                                 <Link href="https://dashboard.expedicaht.com">{service_info}</Link></h4>
                           </div>
                     ...
                     {paid_tools_data.slice(17, 24).map((item, i)  => 
