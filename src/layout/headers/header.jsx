                     ...
                     <div className="row align-items-start">
                        <div className="col-6">
                           <div className="header-top__link">
                              <span>NEW: ExpediChat launches the world's first  Assured SEO Tool</span>
                              <Link href="https://expedichat.com/" target='_blank'>
                        ...
                        <div className="col-6">
                           <div className="header-top__support text-end">
                              <span>Get Support: <Link href="mailto:info@expedichat.com">info@expedichat.com</Link></span>
                           </div>
                        </div>
                     </div>
                  </div>
                        ...
                        <div className="col-xxl-4 col-xl-5 col-lg-5 col-md-8 col-6">
                           <div className="header-bottom__right d-flex align-items-center justify-content-end">
                              <div className="header-bottom__action">
                                 ...
                                 <Link className="d-none d-lg-inline-block last-child" target='_blank' href="http://localhost:3030/sign-in">
                                    <UserIcon /> 
                                    <span>Log In</span>
                                 </Link>
                              </div>
                              <div className="header-bottom__btn d-flex align-items-center">
                                 <Link className="tp-btn-white tp-btn-hover alt-color-black d-none d-md-inline-block" target='_blank' href="http://localhost:3030/sign-up">
