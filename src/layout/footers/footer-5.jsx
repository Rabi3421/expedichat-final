...
const footer_content = {
  info: (
    <>
      Achieve peak performance by integrating smart tools into your work
      routine.
    </>
  ),
  //   phone: "+806 (000) 88 99",
  email: "info@expedichat.com",
          ...
          {style_contact && (
            <>
              <div className="tp-footer__shape-1 d-none d-xxl-block">
                <Image src={shape_img_1} alt="ehatech-services" />
              </div>
                  ...
                  <div className="tp-footer__contact-info">
                    ...
                    <ul>
                      ...
                      <li>
                        <span>
                          <Link
                            href="https://play.google.com/store/apps/details?id=com.writingassistantapp&hl=en"
                            target="_blank">
                            Get Our Live App!
                          </Link>
                        </span>
