...
const footer_content = {
  ...
  description: (
    <>
      Achieve peak performance by integrating <br /> smart tools into your work
      routine.
    </>
  ),
  //  phone: "+806(000)8899",
  contact_mail: "info@expedichat.com",
  location:
    "C-1101, 11th Floor, Tower C Urbtech Trade Center Sec -132, Noida - 201304",

  copy_right: (
    <>
      Full Copyright & Developed By{" "}
      <Link href="ehatech.co">@EhaTech Services Pvt Ltd</Link> –{" "}
  ...
  footer_lisks: [
    {
      ...
      delay: ".7s",
      links: [
        { name: "Assured SEO", link: "/ai-tools/assured-seo" },
        { name: "Humanize Content", link: "/ai-tools/humanize-content" },
        { name: "PPT Generator", link: "/ai-tools/ppt-generator" },
        { name: "Summarizer", link: "/ai-tools/summarizer" },
        { name: "Image To Text", link: "/ai-tools/image-to-text" },
        { name: "Scan To Native PDF", link: "/ai-tools/scan-to-native" },
      ],
    },
    {
      id: 2,
      ...
      delay: ".9s",
      links: [
        { name: "Dashboard", link: "dashboard.expedichat.com" },
        { name: "About", link: "/about" },
        { name: "Blog", link: "/blog" },
        { name: "Contact", link: "/contact" },
        {
          name: "Privacy policy",
          link: "dashboard.expedichat.com/privacy-policy",
        },
        {
          name: "Terms & Conditions",
          link: "dashboard.expedichat.com/terms-and-conditions",
        },
      ],
    },
  ],
              ...
              <div className="tp-footer__border-bottom">
                <div className="row align-items-center">
                  <div
                    ...
                    data-wow-delay=".3s">
                    <Link
                      className="tp-footer__top-text"
                      href="https://play.google.com/store/apps/details?id=com.writingassistantapp"
                      target="_blank">
                      <span>{title}</span>
                    </Link>
                  </div>
                  ...
                  <div
                    ...
                    <div className="tp-footer__widget footer-col-1">
                      <Link href="/" className="tp-footer__widget-logo mb-10">
                        <Image src={footer_logo} alt="" width={200} />
                      </Link>
