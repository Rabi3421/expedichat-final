...
import about_img_2 from "../../public/assets/img/about/Untitled designdcv.webp"
import about_img_3 from "../../public/assets/img/about/png.webp"
import about_img_4 from "../../public/assets/img/about/Instant-Query-Resolution--(-png-).webp"
...
// about content
const about_content = {
    title: "OVER 100K DOWNLOADS",
    sub_title: "Find Answers, Ignite Ideas, and Achieve More ", 
    des: <>Revolutionize your approach to finding solutions and generating ideas with the best AI chat system:</>,
                     ...
                     <div className="col-xl-6 col-lg-6 wow tpfadeRight" data-wow-duration=".9s" data-wow-delay=".6s">
                        <div className="tp-about__right">
                           ...
                           <div className="tp-about__btn">
                              <Link className="tp-btn tp-btn-hover alt-color-black" href="/ai-chat">
                                 <span>{btn_text}</span>
                                 <b></b>
                              </Link>
                           </div>
