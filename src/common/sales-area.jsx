...
import sales_img_1 from "../../public/assets/img/card/Advanced-AI-Technology-&-Integrated-Chat-System.jpg"
import sales_img_2 from "../../public/assets/img/card/Thorough-Analysis-of-Files.jpg"
import sales_img_3 from "../../public/assets/img/card/sale-3.png"

const sales_content = {
    title: <>Manual Searching Ends with the Arrival of AI Chat</>,
    dub_title: <>Manual Searching Ends with the Arrival of AI Chat</>,
    description: <>Embrace the future of effortless, intelligent answers with the best AI Chat system.</>,

    sales_feature: [
        {
            id: 1,
            color: "yellow-1",
            list: "Advanced AI Technology"
        },
        {
            id: 2,
            color: "purple-2",
            list: "Integrated Chat System"
        },
        {
            id: 3,
            color: "green-3",
            list: "Thorough Analysis of Files"
        },
    ],
